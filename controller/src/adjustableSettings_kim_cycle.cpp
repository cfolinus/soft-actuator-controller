...
const double PRESSURE_READ_DELAY = 10; // milliseconds
...
const double KP = 0.45;	  // Start with Kp = 0.1, Ki = 0.0, Kd = 0.0 for Zeigler-Nichols tuning
const double KI = 0.84;
const double KD = 0.0;
...
const float TIMES[] = {0, 725, 775, 2225, 2275, 3000};  // milliseconds
const double PRESSURES[] = {0, 0, 17.4, 17.4, 0, 0};  // PSI or Kpa
