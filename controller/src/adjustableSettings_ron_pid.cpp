...
const int ANALOG_PRESSURE_MIN = 145;
const int ANALOG_PRESSURE_MAX = 173;
const int ANALOG_VENT_MIN = 143;
...
const double SENSOR_OFFSET = 0.24; // Offset used to calibrate a specific sensor
...
const double KP = 0.34;	  // Start with Kp = 0.1, Ki = 0.0, Kd = 0.0 for Zeigler-Nichols tuning
const double KI = 1.69;
const double KD = 0;
