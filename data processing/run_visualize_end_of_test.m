...
% ----------------------------------------------------------------------
%
% This script loads data from a specific cycle testing trial/test (data from one
% .mat file) and visualizes pressure-related metrics to show when/how the
% end-of-test is triggered (i.e., what conditions were met to determine failure)
%
% ----------------------------------------------------------------------
...
trial_name = 'cycle_specimen39_trial1';
...
% Determine first cycle to trigger failure criteria
